...
app.use('/node_modules/nhsuk-frontend', express.static(path.join(__dirname, '/node_modules/govuk-frontend')))
...
var V31Routes = require('./app/views/V3-1/common/routes');
app.use('/V3-1', V31Routes);
