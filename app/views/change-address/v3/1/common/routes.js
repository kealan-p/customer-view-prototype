module.exports = (function() {
    ...
    router.post('/digital-service/circumstances/cora/address_location', function (req, res) {
        ...
        if (editChoice === 'UK') {
          res.redirect('/V3-2/digital-service/circumstances/cora/search-pattern');
        } else if (editChoice === 'Other') {
          res.redirect('/V3-2/digital-service/circumstances/cora/international_address_pattern');
        } else {
    ...
    router.post('/digital-service/circumstances/cora/search-pattern', function (req, res) {
        ...
        if (postcode === 'LS1') {
          res.redirect('/V3-2/digital-service/circumstances/cora/confirm-address-pattern');
        } else if (postcode === 'LS2') {
          res.redirect('/V3-2/digital-service/circumstances/cora/select_address_pattern');
        }  else if (postcode === 'LS3') {
            res.redirect('/V3-2/digital-service/circumstances/cora/no-address');
          } else {
...
console.log(postcode, property);
    ...
    router.post('/digital-service/circumstances/cora/move_date', function (req, res) { 
     ...
     router.post('/digital-service/circumstances/cora/rent_or_own', function (req, res) { 
      res.redirect('/V3-2/digital-service/circumstances/cora/live_with');     
     });

     router.post('/digital-service/circumstances/cora/live_with', function (req, res) { 
      res.redirect('/V3-2/digital-service/circumstances/cora/complete');     
     });
//address_location
