...
router.post('/idp/hmrciv/idvselection', (req, res) => {
  ...
  // Fallback
    ...
    res.redirect('/../idp/hmrciv/choose-2-items-error')
  }
})


router.post('/idp/hmrciv/payslip', (req, res) => {
  res.redirect('./payslip-question-1');
})

router.post('/idp/hmrciv/p60', (req, res) => {
  res.redirect('./p60-question-1');
})

router.post('/idp/hmrciv/tcKbv', (req, res) => {
  res.redirect('./tax-credits-question-1');
})

router.post('/idp/hmrciv/tuKbv', (req, res) => {
  res.redirect('./tu-question-1');
})

router.post('/idp/hmrciv/voiceId', (req, res) => {
