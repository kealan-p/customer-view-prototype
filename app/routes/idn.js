...
router.post('/idn/hmrciv/idnselection', (req, res) => {
  ...
  // Fallback
    ...
    res.redirect('/../idn/hmrciv/choose-2-items')
  }
})


router.post('/idn/hmrciv/payslip', (req, res) => {
  res.redirect('./payslip-question-1');
})

router.post('/idn/hmrciv/p60', (req, res) => {
  res.redirect('./p60-question-1');
})

router.post('/idn/hmrciv/tcKbv', (req, res) => {
  res.redirect('./tax-credits-question-1');
})

router.post('/idn/hmrciv/tuKbv', (req, res) => {
  res.redirect('./tu-question-1');
})

router.post('/idn/hmrciv/voiceId', (req, res) => {
